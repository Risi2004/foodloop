...
const createCustomIcon = (type) => {
    // We only use pickup SVG but want it green
    ...
    // For this specific request, we want the pickup shape (circle) with GREEN color.
    // 'pin-pickup' is defined in CSS to be green (#2ECC71)

...
const MapLegend = () => (
    <div className="map__legend">
        ...
        <div className="legend__item">
            <div className="legend__icon dropoff">
...
// Zoom Control Handler Component (to expose map instance to parent)
...
function Map() {
    ...
    // Initial Center: Colombo, Sri Lanka
